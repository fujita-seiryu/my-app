...
const CHANT_PATTERNS = [
  ...
  },
  {
    ...
    beats: [
      ...
      [{ degree: "ド", oct: 1, dur: 2 }, { degree: "レ", oct: 1, dur: 1 }, { degree: "ミ", oct: 1, dur: 1 }],
      [{ degree: "ド", oct: 1, dur: 4 }],
      null,
  ...
  },
  {
    ...
    beats: [
      ...
      [{ degree: "ド", oct: 1, dur: 1 }, { degree: "ラ", oct: 0, dur: 1 }, { degree: "ソ", oct: 0, dur: 2 }],
  ...
  },
  {
    ...
    beats: [
      ...
      [{ degree: "ド", oct: 1, dur: 1 }, { degree: "ラ", oct: 0, dur: 1 }, { degree: "ソ", oct: 0, dur: 1 }, { degree: "ミ", oct: 0, dur: 1 }],
      ...
      [{ degree: "ラ", oct: 0, dur: 1 }, { degree: "ソ", oct: 0, dur: 1 }, { degree: "ラ", oct: 0, dur: 1 }, { degree: "ド", oct: 1, dur: 1 }],
...
// PERFECT_THRESHOLD以内は「ピタリ合っている」とみなし、♭♯を両方同時点灯させる
// （利用者が「正しい音が出せている」と実感できるようにするための演出）。
...
function updateFlatSharpArrows(cents) {
  ...
  if (abs <= PERFECT_THRESHOLD) {
    el.flatArrow.classList.add("lit");
    el.sharpArrow.classList.add("lit");
    return;
  }
